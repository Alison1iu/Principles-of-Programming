...
"loop", "read", "write", "and", "or"};
   ...
   * @return 
   */
  private GrammerToken getReservedWord(int ch) throws IOException, ParserException
  {
    ...
    if(flag == BAD_RW_TOKEN)
    {
      throw new ParserException("SEVERE: Invalid Token: [Line "+lineno+"] Invalid reserved word "+builder.toString());
    }
   ...
   * @throws IOException 
   */
  private GrammerToken getIdentifier(int ch) throws IOException, ParserException
  {
    StringBuilder builder = new StringBuilder();
    builder.append((char)ch);
    ...
    if(flag == BAD_ID_TOKEN)
    {
      throw new ParserException("SEVERE: Invalid Token: [Line "+lineno+"] Invalid Identifier "+builder.toString());
    }
   ...
   * @throws IOException 
   */
  private GrammerToken getInteger(int ch) throws IOException, ParserException
  {
    StringBuilder builder = new StringBuilder();
    builder.append((char)ch);
    ...
    if(flag == BAD_IN_TOKEN)
    {
      throw new ParserException("SEVERE: Invalid Token: [Line "+lineno+"] Invalid numeric constant "+builder.toString());
    }
    String tokenvalue = builder.toString();
   ...
   * @throws IOException 
   */
  private GrammerToken getSpecialSymbol(int ch) throws IOException, ParserException
  {
    StringBuilder builder = new StringBuilder();
    builder.append((char)ch);
    ...
    if(flag == BAD_SS_TOKEN)
    {
      throw new ParserException("SEVERE: Invalid Token: [Line "+currentlineno+"] Invalid special symbol "+builder.toString());
    }
   ...
   * @throws edu.osu.cse.parser.ParserException 
   */
  public GrammerToken currentToken() throws ParserException
  {
